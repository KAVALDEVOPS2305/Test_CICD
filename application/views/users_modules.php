...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    ...
    <body>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="fa fa-cubes"></i>Manage Users Modules<br><small>Add, Edit Users Modules to operate</small>
                                </h1>
                            </div>
                        </div>
                        <ul class="breadcrumb breadcrumb-top">
                            <li>Administration</li>
                            <li><a href="admin_modules">User Modules</a></li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2>Add/Update <strong>Users Modules</strong></h2>
                                    </div>
                                    <!-- END Horizontal Form Title -->

                                    <!-- Horizontal Form Content -->
                                    <form method="post" id="form_usersmodule" class="form-horizontal form-bordered" onsubmit="return false;">
                         ...
                         <div class="block full">
                            <div class="block-title">
                                <h2>Manage <strong>Users Modules</strong></h2>
                            </div>
                            <div class="table-responsive">
                                <table id="datatable-adminmodule" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <?php     
                                    $result=$this->db->order_by(1, 'DESC')->get('userpanel_modules');
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                {
                                                ?>
                                                    <a href="javascript:void(0);" onclick="changestatus('<?php echo $row->user_module_id ?>','<?php echo $row->module_status ?>')" class="label label-success">Active</a> 
                                                ...
                                                {
                                                ?>
                                                    <a href="javascript:void(0);" onclick="changestatus('<?php echo $row->user_module_id ?>','<?php echo $row->module_status ?>')" class="label label-danger">In-active</a>
                                                <?php }?>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="javascript:void(0)" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default" onclick="getedit_data('<?php echo $row->user_module_id ?>')"><i class="fa fa-pencil"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
        ...
        <script>
            ...
            $('#form_usersmodule').on('submit', function(e)
            {
                if($("#form_usersmodule").valid())
                {
                    if($('#cid').val()) {
                        $('#updatebtn').prop('disabled', true);
                        update_data("form_usersmodule","<?= base_url();?>actionupdate/users_modules"); 
                    }
                    else {
                        $('#savebtn').prop('disabled', true);
                        ins_data("form_usersmodule","<?= base_url();?>actioninsert/users_modules");
                    }
                }
                else
                    e.preventDefault();        
            ...
            function getedit_data(rowid)
            {
                //alert(rowid);
                $.ajax({
                    url :  "<?= base_url();?>actiongetdata/users_modules",
                    type : "POST",
                    datatype : "json",
                    data : { 'id'   : rowid },
            ...
            function changestatus(row_id,curr_status)
            {
                ...
                if(curr_status=='1')
                    ...
                    new_status='1';
                //alert(nst);
                update_status(row_id, new_status,"<?= base_url();?>actionstatusupdate/users_modules" );
            }
        </script>
