    ...
    <body>
                    ...
                    <div id="page-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        <h2>Search <strong>Open NDR Shipments</strong></h2>
                                    ...
                                    <form method="post" id="form_searchopenndrshipments" action="<?php echo base_url('Actionexport/reports_ndr')?>" class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="ndr_status" value="0">
                                            <div class="col-md-3">
                        ...
                        <div class="block full" id="table-div" style="display: none;">
                            <div class="block-title" style="margin-bottom: 0px;">
                                <h2>View <strong>Open NDR Shipments</strong></h2>
                                <div class="block-options pull-right">
        ...
        <script>
            $(function(){
                ...
                $('#future_delivery').datepicker('setStartDate', new Date());
                $('#future_delivery').val(moment().format('DD-MM-YYYY'));

                search_data("form_searchopenndrshipments","<?= base_url();?>actionsearch/search_open_ndrshipments/0");
            });
            ...
            {
                $('#form_searchopenndrshipments').submit();
            });
            ...
            $(document).on('click', '.pagination li a', function(event)
            {
                ...
                search_data("form_searchopenndrshipments","<?= base_url();?>actionsearch/search_open_ndrshipments/"+(page-1)*1000);
            });
