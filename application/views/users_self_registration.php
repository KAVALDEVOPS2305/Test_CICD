                ...
                <div id="page-content">
                    ...
                    <div class="content-header">
                        <div class="header-section">
                            <h1>
                                <i class="fa fa-user-plus"></i>Complete Register User<br><small>Add/Complete Register User</small>
                            </h1>
                        </div>
                    </div>
                    ...
                    if(isset($_GET['uid']))
                    {
                        ...
                        if($uid!='')
                        {
                            $result=$this->db->select('*')->where('tmp_userid=',$uid)->get('users_temp');
                            $user_self = $result->row();
                    ...
                    ?>
                                        ...
                                        <div id="clickable-first" class="step">
                                            ...
                                            <div class="form-group">
                                                <div class="component-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="fullname" name="fullname" class="form-control" value="<?php echo $user_self->fullname; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="component-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="email" id="email_id" name="email_id" class="form-control" value="<?= $user_self->email_id?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="component-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="contact" name="contact" class="form-control" value="<?= $user_self->contact?>" minlength="10" maxlength="10">
                                                        <input type="hidden" name="mobile_verify" id="mobile_verify" value="<?= $user_self->mobile_verify?>">
                                                        <input type="hidden" name="passkey" id="passkey" value="<?= $user_self->password?>">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="component-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="business_name" name="business_name" class="form-control" value="<?= $user_self->business_name?>">
                                                    </div>
                                                </div>
                                        ...
                                        <div id="clickable-second" class="step">
                                            ...
                                            <div class="form-group">
                                                <div class="component-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <select name="billing_type" id="billing_type" class="form-control" data-placeholder="Select Billing type..." value="<?= $user_self->billing_type?>">
                        ...
                        <?php
                            ...
                            echo "<script> location.href='complete_registration';</script>";
                        }
                    else
                        echo "<script> location.href='complete_registration';</script>";
                    ?>
    ...
    <script>
        ...
        $('#form_userregistration').on('submit', function(e)
        {
            if($("#form_userregistration").valid())
            {
                ...
                upload_data("form_userregistration","<?= base_url();?>Actionupdate/users_complete_register",data);
            }
            else
                e.preventDefault();
        });
